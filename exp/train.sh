...
if [ -z "$mixed_precision" ]; then
  python ../tools/train.py model.py --work-dir logs/test_atss_fullp_voc_${random_hash}
else
  python ../tools/train.py modelfp16.py --work-dir logs/test_atss_mixed_voc_${random_hash}
fi

# python ../tools/train.py model.py --work-dir logs/not_custom_atss_fullp_voc_${random_hash}
# python ../tools/train.py modelfp16.py --work-dir logs/not_custom_atss_mixed_voc_${random_hash}
